...
void main() => runApp(MiempresaApp());

class MiempresaApp extends StatelessWidget {
  @override
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(color: Colors.cyan, image: DecorationImage(image: NetworkImage("https://raw.githubusercontent.com/CamilaVS/Mis_imagenes/main/electrico.jpg"), alignment: Alignment.topCenter) //fin de decoration image
            ), //fin box decoration
